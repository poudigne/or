...
<div class="col-lg-4" style="float: none; margin:0 auto !important">
    ...
    <form method="post" action="{{ route('save-suggestion') }}" files="true" id="music-suggest-form" enctype="multipart/form-data">
        ...
        <div class="form-group"><p>
            ...
            <input type="file" id="songFile" name="song_file" data-validation="size mime required" data-validation-allowing="mpeg" data-validation-max-size="15M" data-validation-error-msg-required="No file selected">
        </p></div>
